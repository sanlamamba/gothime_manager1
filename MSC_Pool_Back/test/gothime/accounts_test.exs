defmodule TimeManager.AccountsTest do
  ...
  describe "users" do
    ...
    @invalid_attrs %{username: nil, email: nil, is_visible: nil}
    ...
    test "create_user/1 with valid data creates a user" do
      valid_attrs = %{username: "some username", email: "some email", is_visible: true}
    ...
    test "update_user/2 with valid data updates the user" do
      user = user_fixture()
      update_attrs = %{username: "some updated username", email: "some updated email", is_visible: false}
